...
public class UnifiedDemoDbMigrationService : ITransientDependency
{
    private ILogger<UnifiedDemoDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly IEnumerable<IUnifiedDemoDbSchemaMigrator> _dbSchemaMigrators;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public UnifiedDemoDbMigrationService(
        IDataSeeder dataSeeder,
        IEnumerable<IUnifiedDemoDbSchemaMigrator> dbSchemaMigrators,
        ...
        ICurrentTenant currentTenant)
    {
        ...
        Logger = NullLogger<UnifiedDemoDbMigrationService>.Instance;
    }
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Directory.GetDirectories(srcDirectoryPath)
            .FirstOrDefault(d => d.EndsWith("PostgreSql.EntityFrameworkCore"))!;
    }
