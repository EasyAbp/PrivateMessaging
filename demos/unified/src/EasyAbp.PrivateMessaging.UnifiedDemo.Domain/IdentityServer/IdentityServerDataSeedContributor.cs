...
namespace EasyAbp.PrivateMessaging.UnifiedDemo.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateApiResourcesAsync()
        {
            ...
            await CreateApiResourceAsync("PrivateMessaging", commonApiUserClaims);
        }
        ...
        private async Task CreateClientsAsync()
        {
            ...
            //Console Test Client
            var consoleClientId = configurationSection["PrivateMessaging_ConsoleTestApp:ClientId"];
