...
public class MainDemoDbMigrationService : ITransientDependency
{
    private ILogger<MainDemoDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly IEnumerable<IMainDemoDbSchemaMigrator> _dbSchemaMigrators;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public MainDemoDbMigrationService(
        IDataSeeder dataSeeder,
        IEnumerable<IMainDemoDbSchemaMigrator> dbSchemaMigrators,
        ...
        ICurrentTenant currentTenant)
    {
        ...
        Logger = NullLogger<MainDemoDbMigrationService>.Instance;
    }
