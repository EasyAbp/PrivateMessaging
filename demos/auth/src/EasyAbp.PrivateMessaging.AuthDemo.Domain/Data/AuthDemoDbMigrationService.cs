...
public class AuthDemoDbMigrationService : ITransientDependency
{
    private ILogger<AuthDemoDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly IEnumerable<IAuthDemoDbSchemaMigrator> _dbSchemaMigrators;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public AuthDemoDbMigrationService(
        IDataSeeder dataSeeder,
        IEnumerable<IAuthDemoDbSchemaMigrator> dbSchemaMigrators,
        ...
        ICurrentTenant currentTenant)
    {
        ...
        Logger = NullLogger<AuthDemoDbMigrationService>.Instance;
    }
